...
- Homebrew tap support via `kristianhansen/homebrew-universal-claude-code-config`
- `SECURITY.md`, `CONTRIBUTING.md`, `CODE_OF_CONDUCT.md`, `LICENSE` (MIT)
- GitHub issue templates, PR template, and ShellCheck CI workflow

[1.0.0]: https://github.com/kristianhansen/universal-claude-code-config/releases/tag/v1.0.0
